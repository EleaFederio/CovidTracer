...
<form class="form-signin" action="<?= base_url('/people/login') ?>" method="post">
    ...
    <center><a class="mt-5 mb-3" href="<?= base_url('/people/register')?>" style="margin-top: 50%">Create Account</a></center><br>
    <center><a class="mt-5 mb-3" href="<?= base_url('/establishment/register')?>" style="margin-top: 50%">Covid Tracer for Establishment</a></center>
